  ...
  return (
    <div className="sticky top-0 z-10 bg-background/90 backdrop-blur-sm border border-[#1f1f1f] rounded-xl p-3 space-y-2.5">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <span className="font-mono text-[10px] uppercase tracking-[2px] text-[#7a7a7a] mr-1 shrink-0">{t('range_label')}</span>
        <ChartRangeSelector
          value={filters.range}
      ...
      {availableCategories.length > 0 && (
        <div className="flex items-center gap-1.5 flex-wrap">
          <span className="font-mono text-[10px] uppercase tracking-[2px] text-[#7a7a7a] mr-1 shrink-0">{t('filter_label')}</span>
